...
export const REGIONS: Record<string, Region> = {
  r_starting_plains: {
    ...
    gachaPrizeIds: ["i_herb", "i_magic_water", "i_wooden_sword"], 
        battleBackgroundUrl: "https://raw.githubusercontent.com/akumago/kaihatu/main/mittigazou/ZScuSao%20-%20Imgur.jpg", 
    isUnlocked: true,
    isCleared: false,
  },
  r_dark_forest: {
    ...
    gachaPrizeIds: ["i_herb", "i_magic_water", "i_bronze_sword", "i_chain_mail"],
        battleBackgroundUrl: "https://raw.githubusercontent.com/akumago/kaihatu/main/mittigazou/T8rnbDp%20-%20Imgur.jpg", 
    isUnlocked: false,
    isCleared: false,
  },
  r_mountain_cave: {
    ...
    gachaPrizeIds: ["i_magic_water", "i_steel_sword", "i_plate_armor", "i_knight_shield"],
        battleBackgroundUrl: "https://raw.githubusercontent.com/akumago/kaihatu/main/mittigazou/RrQoDKp%20-%20Imgur.jpg", 
    isUnlocked: false,
    isCleared: false,
  },
  r_micchy_tower: {
    ...
    gachaPrizeIds: ["i_knight_sword", "i_knight_armor", "i_sacred_shield", "i_steel_sword", "i_plate_armor", "i_knight_shield", "i_gm_dew"],
        battleBackgroundUrl: "https://raw.githubusercontent.com/akumago/kaihatu/main/mittigazou/pKQyfkj%20-%20Imgur.jpg",
    isUnlocked: false,
    isCleared: false,
  },
  r_micchy_castle: {
